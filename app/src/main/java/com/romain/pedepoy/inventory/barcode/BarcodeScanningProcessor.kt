package com.romain.pedepoy.inventory.barcode
...
class BarcodeScanningProcessor(private val successListener:(FirebaseVisionBarcode)->Unit) : VisionProcessorBase<List<FirebaseVisionBarcode>>() {
